...
export const subjectsController = {
    ...
    listStrands: async (c) => ok(c, await subjectsService.listStrands(Number(c.req.param('subjectId')))),
    createStrand: async (c) => created(c, await subjectsService.createStrand(getValidated(c, 'json'))),
