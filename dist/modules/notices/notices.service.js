...
export const noticesService = {
    ...
    async getById(id) {
        ...
        if (!notice)
            throw new NotFoundError(`Notice ${id} not found`);
        return notice;
    },
    create(input) {
    ...
    listForParents: (classId) => noticesRepository.findPublishedForAudience('parents', new Date().toISOString().slice(0, 10), classId),
