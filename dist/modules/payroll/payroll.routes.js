...
import { addSalaryComponentSchema, createEmployeeSchema, createPayrollRunSchema, processPayrollRunSchema, } from './payroll.schema.js';
...
payrollRoutes.post('/employees/:employeeId/components', requirePermission('payroll.manage'), zValidator('json', addSalaryComponentSchema), payrollController.addSalaryComponent);
