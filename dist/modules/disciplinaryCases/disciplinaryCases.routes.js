...
disciplinaryCasesRoutes.post('/:id/parent-attendance', requirePermission('disciplinary_cases.manage'), zValidator('json', recordParentAttendanceSchema), disciplinaryCasesController.recordParentAttendance);
